...
## Outline:
This demo is a project provided by Jeremy's IT Lab. The topology was provided by the course, however, I was tasked with configuring all devices.

## Configurations:
L2 Etherchannel was configured between the distribution switches in the A and B segments of the network, while L3 Etherchannel was configured between the core switches. A packet tracer glitch makes the core switch connection show up as down, however both switches show connectivity in the show etherchannel summary output.
...
Wireless LANs and corresponding dynamic interfaces are configured on the WLC via GUI.
